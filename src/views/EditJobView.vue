...
const handleSubmit = async () => {
    ...
    try {
        const response = await axios.put(`/api/jobs/${jobId}`,updtaedJob);
        toast.success('Job updtaed successfuly');
        router.push(`/job/${response.data.id}`);
    } catch (error) {
        // toast.error('Job not addedd');
...
onMounted(async()=>{
    try {
        ...
        console.log('errror fetching job ',error);
            ...
            <div class="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
                <form @submit.prevent="handleSubmit">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="type" v-model="form.type" name="type" class="border rounded w-full py-2 px-3"
                            required>
                    ...
                    <div class="mb-4">
                        ...
                        <select id="salary" name="salary" v-model="form.salary" class="border rounded w-full py-2 px-3"
                            required>
